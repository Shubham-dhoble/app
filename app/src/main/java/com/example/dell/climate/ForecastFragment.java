package com.example.dell.climate;
...
/**
 * Created by Shubham Dhoble on 2/15/2017.
 */
...
public class ForecastFragment extends Fragment {
    ...
    @Override
    protected void onOptionsItemSelected(Bundle savedInstances){
        super.onOptionsItemSelected(savedInstances);
